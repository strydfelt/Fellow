...
import sg.govtech.fellow.FellowApp;
...
//        logCurrentState();
    ...
    private void createLocationRequest() {
        ...
        mLocationRequest.setInterval(FellowApp.UPDATE_INTERVAL_IN_MILLISECONDS);
        mLocationRequest.setFastestInterval(FellowApp.FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS);
